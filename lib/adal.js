...
AuthenticationContext.prototype.login = function () {
    ...
    var urlNavigate = this._getNavigateUrl('id_token', this.config.loginResource) + '&nonce=' + encodeURIComponent(this._idTokenNonce);
...
AuthenticationContext.prototype._renewIdToken = function (callback) {
    ...
    var urlNavigate = this._getNavigateUrl('id_token', this.config.loginResource) + '&prompt=none&login_hint=' + encodeURIComponent(this._user.userName);
